...
pub struct EguiDrawingResources {
...
impl DeferredInit {
    fn new(event_loop: &ActiveEventLoop, ctx: egui::Context) -> DeferredInit {
        ...
        DeferredInit { window, egui_state }
    }
}
...
impl<Graphic: GraphicHandler, Logic: LogicHandler> ApplicationHandler for EventHandler<Graphic, Logic> {
    ...
    fn window_event(&mut self, event_loop: &ActiveEventLoop, window_id: WindowId, event: WindowEvent) {
        ...
        let Some(DeferredInit{ window, egui_state, }) = &mut self.deferred_init else { return; };
        ...
        match event {
            ...
            WindowEvent::RedrawRequested => {
                ...
                let egui::FullOutput{
                    ...
                    shapes,
                    pixels_per_point,
                    viewport_output: _, // TODO: properly handle multiple viewports...
                ...
                let resources = EguiDrawingResources {
                    textures_delta,
                    primitives,
                    pixels_per_point,
                };
                self.graphic_handler.draw(resources);
